<?php if ($expediente) : ?>
    ...
    <div class="card-body">
        ...
        <h6 class="">hannagover@gmail.com</h6>
        <small class="text-muted db">Phone</small>
        <h6 class="">+91 654 784 547</h6>
                ...
                <div class="card-body">
                                ...
                                <div class="col-md-6">
                                    <div class="py-2 px-3 text-bg-light rounded-1 d-flex align-items-center">
                                        ...
                                        <div class="ms-2 text-start">
                                            ...
                                            <h4 class="mb-0 fs-5">Exp: <?= $expediente[0]->numero_expediente ?></h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="py-2 px-3 text-bg-light rounded-1 d-flex align-items-center">
                                        ...
                                        <div class="ms-2 text-start">
                                            ...
                                            <h4 class="mb-0 fs-5"><?= substr($expediente[0]->recibido, 0, 16) ?></h4>
                    ...
                    <div class="vstack gap-3">
                        <div class="hstack gap-6 border-bottom pb-3">
                            ...
                            <div>
                                <h4 class="fs-4 mb-0"><?= $expediente[0]->asunto ?></h4>
                                <p class="mb-0">
                        ...
                        <div class="hstack gap-6 border-bottom pb-3">
                            ...
                            <div>
                                <h4 class="fs-4 mb-0"><?= $documento['nombre'] . " " . $expediente[0]->numero_documento ?> : <a href="<?= $adjunto[0]->local_path ?>" target="_blank" class="
                        ...
                        <div class="hstack gap-6 border-bottom pb-3">
                            ...
                            <div>
                                <h4 class="fs-4 mb-0"><?= $expediente[0]->folios ?></h4>
                                <p class="mb-0">
                    ...
                    <div class="btn-group me-2 mb-2 w-100 " role="group" aria-label="First group">
                        <a href="<?= base_url('/cargoexpediente/' . $expediente[0]->id) ?>" target="_blank" class="btn bg-primary-subtle btn-lg">
