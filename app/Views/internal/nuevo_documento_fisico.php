                        ...
                        <div class="card-body ">
                            ...
                            <div class="floating-labels mt-4 pt-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-4">
                                            <input type="email" class="form-control" id="correoNew" required name="correoNew" value="sincorreo@gmail.com">
                                            <span class="bar"></span>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-4">
                                            <input type="address" class="form-control" id="direccionNew" name="direccionNew" value="-" required>
                                            <span class="bar"></span>
                        ...
                        <div class="card-body">
                            ...
                            <div class="floating-labels mt-4 pt-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group mb-4">
                                            <input type="text" class="form-control" id="numDocExp" name="numDocExp" value="-">
                                            <span class="bar"></span>
