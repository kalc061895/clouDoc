...
class Auth extends ShieldAuth
{
     ...
     */
     ...
     /**
      * estas rutas pueden ser personalizables
      * y reciben el parametro $user
      * para usarlo tienes que copiar ed archivo de vendor/shield/src/views 
      * y copiar el archivo para editarlo
      */
