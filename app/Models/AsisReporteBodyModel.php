...
class AsisReporteBodyModel extends Model
{
    protected $table            = 'asis_reporte_body';
    protected $primaryKey       = 'rb_ide';
    ...
    protected $allowedFields    = [
        ...
        'rb_tardanzas_monto',
        'rb_observacion',
        // 'rb_fecha' se gestiona por CURRENT_TIMESTAMP en la BD
        'rb_estado',
        'rb_user_ide',
    ];
    ...
    public function getPersonalAttendanceSummaryByDNI(string $dni, int $rep_ide = null, string $fecha_inicio = null, string $fecha_fin = null)
    {
        ...
        // Esto nos permite filtrar por el DNI de la persona
        $builder->join('asis_reporte', 'asis_reporte.rep_ide = asis_reporte_body.rb_rep_ide', 'inner');
        ...
        $builder->where('rep_estado',1);
        // solo obtenemos de la calificacion de julio 2024 a diciembre 2024
        $builder->where("rep_mes_anio IN ('2024-07','2024-08','2024-09','2024-10','2024-11','2024-12')" );        // Filtrar por rango de fechas si se proporcionan
