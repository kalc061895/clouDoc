...
<div class="card bg-white p-4">
    ...
    <div class="card border-0 shadow-sm rounded-3">
        <div class="card-header bg-white border-bottom p-0">
            ...
            <ul class="nav nav-tabs nav-fill flex-nowrap overflow-auto" id="tabsPostulacion" role="tablist"
                style="scrollbar-width: thin;">
                <!-- TAB 1 -->
                <li class="nav-item" role="presentation">
                    <button class="nav-link active text-nowrap" id="tab-datos" data-bs-toggle="tab"
                        data-bs-target="#panel-datos" type="button" role="tab">
                        <iconify-icon icon="solar:user-bold" class="me-1"></iconify-icon>
                        <span class="d-none d-lg-inline">1. Datos personales</span>
                        <span class="d-lg-none">Datos</span>
                    </button>
                </li>
                <!-- TAB 2 -->
                <li class="nav-item" role="presentation">
                    <button class="nav-link text-nowrap" id="tab-plaza" data-bs-toggle="tab"
                        data-bs-target="#panel-plaza" type="button" role="tab">
                        <iconify-icon icon="solar:case-round-bold" class="me-1"></iconify-icon>
                        <span class="d-none d-lg-inline">2. Plaza</span>
                ...
                <!-- TAB 3 -->
                <li class="nav-item" role="presentation">
                    <button class="nav-link text-nowrap" id="tab-profesional" data-bs-toggle="tab"
                        data-bs-target="#panel-profesional" type="button" role="tab">
                ...
                <!-- TAB 4 -->
                <li class="nav-item" role="presentation">
                    <button class="nav-link text-nowrap" id="tab-academica" data-bs-toggle="tab"
                        data-bs-target="#panel-academica" type="button" role="tab">
                ...
                <!-- TAB 5 -->
                <li class="nav-item" role="presentation">
                    <button class="nav-link text-nowrap" id="tab-experiencia" data-bs-toggle="tab"
                        data-bs-target="#panel-experiencia" type="button" role="tab">
                ...
                <!-- TAB 6 -->
                <li class="nav-item" role="presentation">
                    <button class="nav-link text-nowrap" id="tab-capacitaciones" data-bs-toggle="tab"
                        data-bs-target="#panel-capacitaciones" type="button" role="tab">
        ...
        <div class="card-body p-4">
            <div class="tab-content" id="contenidoTabsPostulacion">
                ...
                <div class="tab-pane fade " id="panel-plaza" role="tabpanel">
...
<script>
    $(document).ready(function () {
        ...
        const urls = {
            datos: '<?= base_url('seleccion/postulacion/inscripcion/partial') ?>',
            plaza: '<?= base_url('seleccion/postulacion/inscripcion/partial') ?>',
            profesional: '<?= base_url('seleccion/postulacion/inscripcion/partial') ?>',
            academica: '<?= base_url('seleccion/postulacion/inscripcion/partial') ?>',
            experiencia: '<?= base_url('seleccion/postulacion/inscripcion/partial') ?>',
        ...
        function cargarTab(tab) {
            ...
            $.ajax({
                url: urls[tab] + '/' + convocatoriaId + '/' + tab,
                type: 'GET',
                cache: false,
