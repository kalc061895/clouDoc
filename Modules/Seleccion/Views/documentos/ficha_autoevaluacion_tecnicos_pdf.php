...
<head>
    <meta charset="UTF-8">
    <title>Ficha de Autoevaluación - Técnico</title>
    <style>
        @page {
            margin: 12mm;
        }
    ...
    <table>
        ...
        <tbody>
            <tr class="fw-bold bg-light">
                <td>A. Títulos y Certificados Técnicos</td>
                <td class="text-center">55 puntos</td>
                <td></td>
                <td></td>
            </tr>
            <tr>
                <td>a. Título Técnico No Universitario (3 años) / Título Profesional Técnico</td>
                <td class="text-center">40 puntos</td>
                <td class="text-center"><?= $eval['titulo_tecnico_auto'] ?? '' ?></td>
                <td class="text-center"><?= $eval['titulo_tecnico_rev'] ?? '' ?></td>
            </tr>
            <tr>
                <td>b. Egresado / Certificado de Estudios Técnicos Superior</td>
                <td class="text-center">15 puntos</td>
                <td class="text-center"><?= $eval['estudios_tecnicos_auto'] ?? '' ?></td>
                <td class="text-center"><?= $eval['estudios_tecnicos_rev'] ?? '' ?></td>
            </tr>
            <tr class="fw-bold bg-light">
                <td>B. Eventos y Cursos de Capacitación</td>
