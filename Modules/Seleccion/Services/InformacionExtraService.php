        ...
        if ($file = $request->getFile('archivo')) {
            if ($file && $file->isValid() && ! $file->hasMoved()) {
                ...
                */
                ...
                return ['file'=>$errorMsg,'file2'=>$errorCode,'status' => 'error', 'message' => 'Error al subir  -el archivo Max. 10MB'];
            }
        } else {
                
            return ['file'=>$request,'status' => 'error', 'message' => 'Error al subir el_ archivo Max. 10MB'];
        }
